...
if(isset($_POST['name']) && $_POST['name'] != null ){
    ...
    $action = $_POST['action'];
    $result = $vehicleTypeController->save($_POST, $action);
...
if(isset($_POST['idDelete']) && $_POST['idDelete'] != null ){
    ...
    $result = $vehicleTypeController->delete($_POST['idDelete']);
...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header" >Tipo de veículo - <span id="title">Criar</span></h3>
    </div>                
</div>
<div class="row">
    <div class="col-lg-12">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                if(!$vehicleTypesResult->hasError){
                                    foreach ($vehicleTypesResult->result as $vehicleTypeValue) {
                                        echo '<tr class="odd gradeX">';
                                        echo '<td>'.$vehicleTypeValue->getName().'</td>';
                                        echo '<td class="text-center clickble" onclick="editForm('.$vehicleTypeValue->getId().', \''.$vehicleTypeValue->getName().'\')"><span class="fa fa-edit text-primary"></span></td>';
                                        echo '<td class="text-center clickble" data-toggle="modal" data-target="#'.$vehicleTypeValue->getId().'"><span class="fa fa-trash text-primary"></span></td>';
                                        echo '</tr>';
                                        echo '<div class="modal fade" id="'.$vehicleTypeValue->getId().'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form role="form-delete" method="post" action="#">
                                                    <input type="hidden" name="idDelete" value="'.$vehicleTypeValue->getId().'">
                                                    ...
                                                    <div class="modal-body">
                                                        Tem certeza que deseja deletar '.$vehicleTypeValue->getName().'?
                                                    </div>
